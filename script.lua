...
MainFrame.Size = UDim2.new(0, 320, 0, 480) -- Ampliado para los nuevos controles
...
SliderFill.Size = UDim2.new(0, 0, 1, 0) -- Inicia en 0 (Equivale a 2.5)
...
ScrollFrame.Size = UDim2.new(1, -20, 1, -150) -- Ajustado para el nuevo panel
...
UserInputService.InputChanged:Connect(function(input)
    if arrastrandoSlider and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
        ...
        valorReal = math.floor(valorReal * 10) / 10 -- Redondea a 1 decimal
...
conexiones[#conexiones + 1] = UserInputService.InputBegan:Connect(function(input, procesado)
    -- Si estamos en modo cambiar tecla, evitamos hacer otras acciones
